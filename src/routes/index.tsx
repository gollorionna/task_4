...
export function MainPage() {
  return (
    <>
      ...
      <div className="absolute top-24 sm:top-32 lg:top-40 left-1/3 translate-x-0 lg:left-auto lg:right-20 bg-(--green-bg)/80 rounded-tr-2xl rounded-bl-2xl p-4 sm:w-[70%] md:w-[60%] lg:w-[40%] max-w-160 text-center leading-7">
        <p>New Arrival</p>
